...
switch ($_GET["act"]) {
	...
	$data = array("first_name"=>$_POST["first_name"],"last_name"=>$_POST["last_name"],"username"=>$_POST["username"],"password"=>md5($_POST["password_baru"]),"email"=>$_POST["email"],"id_group"=>$_POST["id_group"],"kode_jurusan" => $_POST['jurusan'],"date_created"=>date('Y-m-d'));
...
$foto_user = array("foto_user"=>$_FILES["foto_user"]["name"]);
	...
	case "delete":
		...
		break;
	case "up":
	 $data = array("first_name"=>$_POST["first_name"],"last_name"=>$_POST["last_name"],"email"=>$_POST["email"],"id_group"=>$_POST["id_group"],"kode_jurusan" => $_POST['jurusan']);
