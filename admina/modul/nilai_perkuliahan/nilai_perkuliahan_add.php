                ...
                <section class="content-header">
                    <h1>
                     Nilai Perkuliahan
                        ...
                        <li class="active">Tambah Nilai Perkuliahan</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Tambah Nilai Perkuliahan</h3>
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/nilai_perkuliahan/nilai_perkuliahan_action.php?act=in">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="kode_mk" placeholder="Kode MK" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Nama MK" class="control-label col-lg-2">Nama MK</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_mk" placeholder="Nama MK" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="nilai_huruf" placeholder="Nilai Huruf" class="form-control" > 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
