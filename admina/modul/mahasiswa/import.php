...
<div id="isi_import"></div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-10">
                           <a href="<?=base_url();?>upload/sample/template_baru_mahasiswa.xlsx" class="btn btn-success btn-flat"><i class="fa fa-cloud-download"></i> Download Contoh Template XLS</a>
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
