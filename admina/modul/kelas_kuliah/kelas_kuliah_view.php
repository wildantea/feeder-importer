...
$i=1;
if ($_SESSION['level']==1) {
$data = $db->fetch_custom("select jurusan.nama_jurusan,count(kelas_kuliah.id) as jumlah_Kelas ,jurusan.kode_jurusan,jenjang from jurusan left join kelas_kuliah
