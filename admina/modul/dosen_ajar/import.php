                ...
                <section class="content-header">
                    <h1>
                     Dosen Ajar
                        ...
                        <li><a href="<?=base_index();?>aktivitas-kuliah-mahasiswa">Dosen Ajar</a></li>
...
<div id="isi_import"></div>
                     <form id="input_import" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/dosen_ajar/dosen_ajar_action.php?act=import">
                     <div class="form-group">
                        <label for="nim" class="control-label col-lg-2">&nbsp;</label>
                        <div class="col-lg-10">
                           <a href="<?=base_url();?>upload/sample/template_dosen_ajar.xlsx" class="btn btn-success btn-flat"><i class="fa fa-cloud-download"></i> Download Contoh Template XLS</a>
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
