...
foreach ($data as $isi) {
      ...
      ?>
      <input type="checkbox" data-on-text="YES" data-off-text="NO"  value="Y" class="make-switch"  checked>
      <input type="hidden" id="tampil" name="tampil" value="Y">
      <?php
    } else {
      ?>
      <input type="hidden" id="tampil" name="tampil" value="N">
      <input  type="checkbox" data-on-text="YES" data-off-text="NO"  value="N" class="make-switch">
      <?php
    }?>  </div>
                      </div><!-- /.form-group -->
